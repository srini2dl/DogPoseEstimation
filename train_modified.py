...
def arg_parser():
    ...
    parser.add_argument("--displayiters", default=1, type=int,
                    help="Logs will be displayed after every displayiters steps")
    parser.add_argument("--saveiters", default=10, type=int, help="model will be saved after every saveiters steps")
    parser.add_argument("--maxiters", default=20, type=int, help="Max iterations to run")
